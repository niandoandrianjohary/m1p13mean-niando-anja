      ...
      <div class="fixed-menu">
        <div class="menu-header" (click)="toggleMenu()">
          ...
          <div class="menu-toggle">
            <i class="fas" [class.fa-bars]="menuCollapsed" [class.fa-times]="!menuCollapsed"></i>
          </div>
        </div>

        <nav class="menu-nav" [class.collapsed]="menuCollapsed">
          <a class="menu-item" (click)="selectSection('dashboard')" [class.active]="currentSection === 'dashboard'">
            <i class="fas fa-tachometer-alt"></i>
            <span *ngIf="!menuCollapsed">Dashboard</span>
          </a>

          <a class="menu-item" (click)="selectSection('pendingShops')" [class.active]="currentSection === 'pendingShops'">
            <i class="fas fa-clock"></i>
            <span *ngIf="!menuCollapsed">Demandes</span>
            <span class="badge" *ngIf="pendingShops.length > 0 && !menuCollapsed">{{ pendingShops.length }}</span>
          </a>

          <a class="menu-item" (click)="selectSection('activeShops')" [class.active]="currentSection === 'activeShops'">
            <i class="fas fa-store"></i>
            <span *ngIf="!menuCollapsed">Boutiques</span>
          </a>

          <a class="menu-item" (click)="selectSection('users')" [class.active]="currentSection === 'users'">
      ...
      <div class="main-content" [class.menu-collapsed]="menuCollapsed">
        ...
        <div *ngIf="currentSection === 'dashboard'" class="dashboard-section">
          ...
          <div class="urgent-section" *ngIf="pendingShops.length > 0">
            ...
            <div class="urgent-list">
              <div class="urgent-item" *ngFor="let shop of pendingShops.slice(0, 3)">
                ...
                <button class="btn-action" (click)="selectSection('pendingShops')">
                  Traiter
                </button>
              </div>
            </div>
          ...
          <div class="pending-list" *ngIf="pendingShops.length > 0">
            <div class="pending-card" *ngFor="let shop of pendingShops">
              <div class="card-header">
                <h4>{{ shop.name }}</h4>
                <span class="category">{{ getCategoryLabel(shop.category) }}</span>
              </div>
              ...
              <div class="card-actions">
                <select [(ngModel)]="shop.assignedLocation" class="location-select">
                ...
                <div class="action-buttons">
                  <button class="btn-success" (click)="approveShop(shop)" [disabled]="!shop.assignedLocation">
          ...
          <div class="shops-grid">
            <div class="shop-card" *ngFor="let shop of getFilteredShops()">
              ...
              <div class="shop-actions">
                ...
                <button class="btn-icon" [ngClass]="shop.status === 'active' ? 'btn-danger' : 'btn-success'"
                        (click)="toggleShopStatus(shop)">
                  <i [class]="shop.status === 'active' ? 'fas fa-ban' : 'fas fa-check'"></i>
                </button>
              </div>
            </div>
          </div>
        ...
        <div *ngIf="currentSection === 'users'" class="users-section">
          ...
          <div class="create-form" *ngIf="showCreateForm">
            ...
            <div class="form-body">
              <input type="text" placeholder="Nom complet" [(ngModel)]="newUser.name">
              ...
              <input type="password" placeholder="Mot de passe" [(ngModel)]="newUser.password">
              <div class="form-actions">
                <button class="btn-success" (click)="createUser()">Créer</button>
                <button class="btn-outline" (click)="showCreateForm = false">Annuler</button>
              </div>
            </div>
          </div>
          ...
          <div class="users-grid">
            <div class="user-card" *ngFor="let user of allUsers">
              ...
              <div class="user-status" [ngClass]="user.active ? 'active' : 'inactive'">
              ...
              <div class="user-actions">
                ...
                <button class="btn-icon" [ngClass]="user.active ? 'btn-danger' : 'btn-success'"
...
export class AdminDashboardComponent implements OnInit {
  ...
  getFilteredShops() {
    ...
    return this.activeShops.filter(shop =>
