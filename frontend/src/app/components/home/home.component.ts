...
@Component({
      ...
      <section class="hero-section">
        ...
        <div class="container hero-content">
          ...
          <p class="hero-description">
            Antananarivo's premier luxury retail destination —
            where sophistication meets curated elegance
          </p>
      ...
      <section class="map-section-luxe">
        <div class="container">
          <div class="section-header">
            ...
            <p class="section-subtitle">Découvrez l'agencement exclusif de nos boutiques</p>
          </div>

          <div class="map-luxe-container">
            <div class="map-visual">
              <div class="map-level">
                <h4 class="level-title">LEVEL <span class="accent">ONE</span></h4>
                <div class="level-shops">
                  <div class="shop-pin luxury" (click)="selectShop('Zara')"
                       [class.active]="selectedShop === 'Zara'">
                    <div class="pin-marker"></div>
                    <div class="pin-label">ZARA</div>
                    <div class="pin-category">Haute Couture</div>
                  </div>
                  <div class="shop-pin fashion" (click)="selectShop('LC Waikiki')"
                       [class.active]="selectedShop === 'LC Waikiki'">
                    <div class="pin-marker"></div>
                    <div class="pin-label">LC WAIKIKI</div>
                    <div class="pin-category">Prêt-à-porter</div>
                  </div>
                  <div class="shop-pin tech" (click)="selectShop('Star')"
              ...
              <div class="map-level">
                <h4 class="level-title">LEVEL <span class="accent">TWO</span></h4>
                <div class="level-shops">
                  <div class="shop-pin dining" (click)="selectShop('Jumbo Score')"
                       [class.active]="selectedShop === 'Jumbo Score'">
                    <div class="pin-marker"></div>
                    <div class="pin-label">JUMBO SCORE</div>
                    <div class="pin-category">Restaurant Étoilé</div>
                  </div>
                  <div class="shop-pin telecom" (click)="selectShop('Orange')"
            ...
            <div class="map-sidebar">
              ...
              <div class="selected-shop-luxe" *ngIf="selectedShop">
                ...
                <div class="selected-content">
                  ...
                  <p class="shop-category">{{ getShopCategory(selectedShop) }}</p>
                  <p class="shop-description">
                    Boutique exclusive proposant les dernières collections
                    dans un cadre raffiné et personnalisé.
                  </p>
                  <button class="btn-luxe btn-view" (click)="viewShopProducts(selectedShop)">
                    VISITER LA BOUTIQUE
                  </button>
                </div>
              </div>
      ...
      <section class="collection-section">
        <div class="container">
          ...
          <div class="products-grid">
            <div class="product-card-luxe" *ngFor="let product of featuredProducts">
              ...
              <div class="product-info">
                ...
                <div class="product-footer">
                  <span class="product-price">{{ formatNumber(product.price) }} MGA</span>
  ...
  styles: [`
    ...
    .shop-pin.luxury::before { background: var(--primary-gold); }
    .shop-pin.fashion::before { background: var(--accent-burgundy); }
    .shop-pin.tech::before { background: #1E90FF; }
    .shop-pin.dining::before { background: var(--success-emerald); }
    .shop-pin.telecom::before { background: #FF8C00; }
    ...
    .shop-pin.luxury .pin-marker { background: var(--primary-gold); }
    .shop-pin.fashion .pin-marker { background: var(--accent-burgundy); }
    .shop-pin.tech .pin-marker { background: #1E90FF; }
    .shop-pin.dining .pin-marker { background: var(--success-emerald); }
    .shop-pin.telecom .pin-marker { background: #FF8C00; }
    ...
    .map-divider {
      height: 1px;
      background: linear-gradient(90deg, transparent, var(--metal-gray), transparent);
      margin: 3rem 0;
    }
    ...
    .legend-color.luxury { background: var(--primary-gold); }
    .legend-color.fashion { background: var(--accent-burgundy); }
    .legend-color.tech { background: #1E90FF; }
    .legend-color.dining { background: var(--success-emerald); }
    .legend-color.telecom { background: #FF8C00; }
...
export class HomeComponent implements OnInit {
  ...
  loadFeaturedProducts() {
    ...
    this.featuredProducts = allProducts.slice(0, 3);
  }
  ...
  addToCart(product: Product) {
    ...
    alert(`${product.name} ajouté au panier pour ${this.formatNumber(product.price)} Ar!`);
  }
